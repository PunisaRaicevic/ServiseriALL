export const en = {
  ...
  clients: {
    ...
    addClientDescription: 'Enter information about the new client',
    ...
    namePlaceholder: 'Company or facility name',
  ...
  appliances: {
    ...
    applianceSingular: 'appliance',
    appliancePlural: 'appliances',
